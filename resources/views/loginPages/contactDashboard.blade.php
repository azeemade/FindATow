	...
	<div class="dashboard-content container">
		<div class="card contact-form">
			...
			<div class="card-body">
				...
				<form method="post" action="{{ url('contact-db') }}">
					{{ csrf_field() }}
					<div class="form-group">
						<input type="text" name="username" placeholder="Name" class="form-control" value="{{ $users->username }}">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<textarea class="form-control" rows="5" name="message" placeholder="Message" reuired></textarea>
					</div>
					<div class="form-group">
